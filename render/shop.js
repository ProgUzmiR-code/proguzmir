...
// 1. ID larni wallet.js dagi PRICES bilan bir xil qildik (gem1, gem2...)
const SHOP_ITEMS = [
...
function renderShop() {
  ...
  content.innerHTML = `
    <div style="margin-top: 50px;">
      ...
      <div style="display:flex; gap:12px; margin-top:6px;">
          ...
          <div id="energyCol" style="flex:1; display:flex; flex-direction:column; gap:12px; display:none;">
            ${SHOP.map(it => `
              <div class="shop-item" data-id="${it.id}" style="margin-bottom: 20px; display: flex; background:rgba(0,0,0,0.5); border-radius:12px; padding:12px;">
                ...
                <div style="margin-top:8px; display:flex; justify-content:space-between; align-items:center; width: 100%; margin-left: 10px;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
              ${SHOP_ITEMS.map(it => `
                  <div class="shop-card" style="background: #f3c178; border-radius: 12px; overflow: hidden; display: flex; flex-direction: column; align-items: center; border: 2px solid #e2a04a; position: relative;">
                      ...
                      <div class="buy-btn" onclick="window.buyItem('${it.id}')" 
  ...
  // Default holatda Diamonds (Shop) ochiq bo'lsin
  activateShop();


  // --- ENERGY SOTIB OLISH (Ichki balans) ---
